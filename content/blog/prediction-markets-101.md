---
title: "Prediction Markets 101: How Kalshi and Polymarket Actually Work"
description: "A plain-English guide to prediction markets: what YES and NO contracts really mean, how Kalshi and Polymarket differ, and how to spot an edge."
date: "2026-06-18"
updated: "2026-06-18"
category: "Explainer"
...
faq:
  - q: "Are prediction markets the same as sports betting?"
    a: "They overlap but they are not the same. A sportsbook sets a price and takes the other side of your bet, building in a margin called the vig. A prediction market is peer to peer: you are buying a contract from another person, and the price is whatever the crowd will pay. That difference in structure is exactly why an edge can show up in one place and not the other."
  - q: "If a YES contract trades at 60 cents, is that a good bet?"
    a: "Sixty cents means the market thinks the event is about 60 percent likely, because a YES contract pays out 1 dollar if it happens and nothing if it does not. It is only a good bet if you genuinely believe the real chance is higher than 60 percent. The price is the market's opinion. Your job is to decide when you disagree with it for a good reason."
---
...
1. **Form your own estimate first.** Before you look at the price, decide what you think the real chance is. If you peek at the price first, you will anchor to it.
2. **Convert the price to a probability.** A contract at 35 cents implies a 35 percent chance. A sportsbook moneyline of +200 implies about 33 percent. Now you are comparing apples to apples.
3. **Look for the gap.** If you believe the real chance is 45 percent and the contract is trading at 35 cents, that gap is your edge. If they are basically the same, there is no bet.
4. **Cross-check the venues.** Compare the prediction-market price to the sportsbook line on the same question. The cleaner number is the one closer to the true probability, and it is often not the one most people are looking at.
